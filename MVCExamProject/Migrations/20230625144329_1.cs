        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Age = table.Column<int>(type: "int", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactUsMSGS", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContactUsMSGS_Users_UserID",
                        column: x => x.UserID,
